        ...
        >
            {msg.role === 'user' ? (
                <div className="flex items-center gap-3 mb-6 pl-2">
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white dark:bg-[#111113] border border-gray-200 dark:border-white/[0.05] shadow-sm transform-gpu">
